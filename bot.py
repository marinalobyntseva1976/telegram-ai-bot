...
COURSES_DATA = {
    "greeting": "👋 Привет! Добро пожаловать в AI-Adminpriority!\n\nЯ помогу вам узнать о наших курсах по работе с искусственным интеллектом для административных директоров и HR-специалистов.\n\nВыберите интересующий вас раздел:",
    ...
    "pricing": "💰 Стоимость:\n\n• Стандарт: 2 500 ₽\n• Для подписчиков журнала «Административный директор»: 1 000 ₽\n• Для партнёров, которые не являются административными специалистами и HR: 15 000 ₽",
    
    "registration": "📝 Как зарегистрироваться?\n\nОтправьте письмо на info@admdir.ru с:\n• Названием курса\n• Датой проведения\n\nВ ответ получите подтверждение и детали.",
